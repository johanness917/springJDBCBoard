...
public class BoardDAO {
	...
	public int insertBoard(Board board) {
		// insert into jdbcBoard values(jdbcBoard_seq.nextval,
...
//		select * from jdbcBoard where no > 0 and title like '%z%';
//		select * from jdbcBoard where no > 0 and writer like '%f%';
//		select * from jdbcBoard where no > 0 and content like '%f%';
